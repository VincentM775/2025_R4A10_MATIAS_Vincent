...
// Implémentez ici
type contenttype = { "Content-Type": string };
type objetD = Record<string, string>;
...
// Implémentez ici
type Guard = {
    canActivate(Request): boolean | Promise<boolean>
}
...
type Reponse = {
    statusCode: Number,
    headers: Record<"Content-Type", string> & Record<string,string>
    boody? : Record<string,unknown>
}
