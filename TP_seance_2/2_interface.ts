...
interface Update<T>{
    update(id:number,entry:T): Promise<T>;
}
interface Delete{
...
// Implémentez ici
interface StudentRepository extends FindMany<Student>, FindOne<Student | null>, Create<Student | null>, Update<Student | null>, Delete{
}

interface CourseRepository extends FindMany<Course>, FindOne<Course | null>, Create<Course | null>, Update<Course | null>{
}
...
class SQLStudentRepository implements StudentRepository{
    ...
    async create(entry: Student): Promise<Student | null> {
        return null;
    }
    async update(id: number, entry: Student): Promise<Student | null> {
        return null;
    }
...
class SQLCourseRepository implements CourseRepository{
    ...
    async create(entry: Course): Promise<Course | null> {
        return null;
    }
    async update(id: number, entry: Course): Promise<Course | null> {
        return null;
    }
}   
